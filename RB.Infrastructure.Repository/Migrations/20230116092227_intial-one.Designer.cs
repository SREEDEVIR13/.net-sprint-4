...
namespace RB.Infrastructure.Migrations
{
    ...
    [Migration("20230116092227_intial-one")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RB.Core.Domain.Models.RequestHandler", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HostedRideId")
                        .HasColumnType("int");

                    b.Property<string>("JoineeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RB.Core.Domain.Models.RequestHandler", b =>
                {
                    b.HasOne("RB.Core.Domain.Models.HostedRides", "HostedRides")
                        .WithMany()
                        .HasForeignKey("HostedRideId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RB.Core.Domain.Models.UserRegister", "UserRegister")
                        .WithMany()
                        .HasForeignKey("JoineeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
